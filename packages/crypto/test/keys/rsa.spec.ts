...
import { exportPrivateKey, generateKeyPair, importPrivateKey, privateKeyFromProtobuf, publicKeyFromProtobuf } from '../../src/keys/index.js'
import { MAX_RSA_KEY_SIZE, importFromPem, pkcs1ToRSAPrivateKey, pkixToRSAPublicKey } from '../../src/keys/rsa/utils.js'
...
describe('RSA', function () {
  ...
  it('encoding', async () => {
    ...
    const key2 = await pkcs1ToRSAPrivateKey(keyMarshal)
  ...
  it('unmarshals a private key', async () => {
    ...
    const privateKey = await pkcs1ToRSAPrivateKey(pkcs1)
