...
## [1.2.17](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.16...devtools-metrics-v1.2.17) (2025-05-22)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.11 to ^1.3.12
  * devDependencies
...
* timeout sending rpc messages after a while ([#3109](https://github.com/libp2p/js-libp2p/issues/3109)) ([3df5bf2](https://github.com/libp2p/js-libp2p/commit/3df5bf2da2d5ccd186db3f3f5012f79ce91c809a))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.9 to ^1.3.10
  * devDependencies
    * @libp2p/crypto bumped from ^5.1.1 to ^5.1.2

## [1.2.14](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.13...devtools-metrics-v1.2.14) (2025-04-16)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.8 to ^1.3.9
  * devDependencies
    * @libp2p/crypto bumped from ^5.1.0 to ^5.1.1

## [1.2.13](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.12...devtools-metrics-v1.2.13) (2025-04-09)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.6 to ^1.3.7

## [1.2.10](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.9...devtools-metrics-v1.2.10) (2025-03-03)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.5 to ^1.3.6
  * devDependencies
    * @libp2p/crypto bumped from ^5.0.14 to ^5.0.15

## [1.2.9](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.8...devtools-metrics-v1.2.9) (2025-03-03)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.4 to ^1.3.5
  * devDependencies
...
## [1.2.6](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.5...devtools-metrics-v1.2.6) (2025-02-21)
...
## [1.2.5](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.2.4...devtools-metrics-v1.2.5) (2025-02-20)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/simple-metrics bumped from ^1.3.2 to ^1.3.3
  * devDependencies
...
## [1.1.6](https://github.com/libp2p/js-libp2p/compare/devtools-metrics-v1.1.5...devtools-metrics-v1.1.6) (2024-10-09)
