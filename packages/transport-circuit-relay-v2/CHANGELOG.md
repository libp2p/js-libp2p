...
## [1.0.2](https://github.com/libp2p/js-libp2p/compare/circuit-relay-v2-v1.0.1...circuit-relay-v2-v1.0.2) (2023-11-30)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/peer-record bumped from ^6.0.11 to ^6.0.12
