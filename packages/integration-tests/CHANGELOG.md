...
## [2.0.0](https://github.com/libp2p/js-libp2p/compare/integration-tests-v1.0.0...integration-tests-v2.0.0) (2025-09-23)
...
* The following workspace dependencies were updated
  * devDependencies
    ...
    * @libp2p/bootstrap bumped from ^12.0.0 to ^13.0.0
    * @libp2p/circuit-relay-v2 bumped from ^4.0.0 to ^5.0.0
    * @libp2p/crypto bumped from ^5.1.9 to ^6.0.0
    * @libp2p/daemon-client bumped from ^10.0.0 to ^11.0.0
    * @libp2p/daemon-server bumped from ^9.0.0 to ^10.0.0
    * @libp2p/dcutr bumped from ^3.0.0 to ^4.0.0
    * @libp2p/echo bumped from ^3.0.0 to ^4.0.0
    * @libp2p/fetch bumped from ^4.0.0 to ^5.0.0
    ...
    * @libp2p/interop bumped from ^14.0.0 to ^15.0.0
    * @libp2p/kad-dht bumped from ^16.0.0 to ^17.0.0
    * @libp2p/logger bumped from ^6.0.0 to ^7.0.0
    * @libp2p/mdns bumped from ^12.0.0 to ^13.0.0
    * @libp2p/memory bumped from ^2.0.0 to ^3.0.0
    ...
    * @libp2p/plaintext bumped from ^3.0.0 to ^4.0.0
