...
## [11.0.0](https://github.com/libp2p/js-libp2p/compare/floodsub-v10.0.0...floodsub-v11.0.0) (2024-09-10)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/pubsub bumped from ^9.0.26 to ^11.0.0
  * devDependencies
    * @libp2p/crypto bumped from ^4.1.9 to ^6.0.0
    * @libp2p/interface-compliance-tests bumped from ^5.4.12 to ^7.0.0
    * @libp2p/logger bumped from ^4.0.20 to ^6.0.0
    * @libp2p/peer-collections bumped from ^5.2.9 to ^7.0.0
