...
export interface PublicKey<Type extends KeyType = KeyType> {
  readonly type: Type
 ...
 */
export interface PrivateKey<Type extends KeyType = KeyType> {
  readonly type: Type
   ...
   *
   * The key id is the base58 encoding of the SHA-256 multihash of its public
   * key. The public key is a protobuf encoding containing a type and the DER
   * encoding of the PKCS SubjectPublicKeyInfo.
   */
  id(): Promise<string>
