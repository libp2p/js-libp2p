...
## [4.1.5](https://github.com/libp2p/js-libp2p/compare/webrtc-v4.1.4...webrtc-v4.1.5) (2024-08-09)
...
* The following workspace dependencies were updated
  ...
  * devDependencies
    ...
    * @libp2p/websockets bumped from ^8.1.4 to ^8.1.5
    * libp2p bumped from ^1.8.3 to ^1.8.4
