...
import type { Identify as IdentifyInterface, IdentifyPush as IdentifyPushInterface, IdentifyComponents, IdentifyInit, IdentifyPushComponents, IdentifyPushInit } from './index.js'
import type { Libp2pEvents, IdentifyResult, SignedPeerRecord, AbortOptions, Logger, Connection, Stream, TypedEventTarget, PeerId, Peer, PeerData, PeerStore, Startable, NodeInfo } from '@libp2p/interface'
...
function getAgentVersion (nodeInfo: NodeInfo, agentVersion?: string): string {
