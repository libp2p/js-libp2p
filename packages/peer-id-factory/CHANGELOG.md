...
## [4.2.4](https://github.com/libp2p/js-libp2p/compare/peer-id-factory-v4.2.3...peer-id-factory-v4.2.4) (2024-08-09)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @libp2p/interface bumped from ^1.6.3 to ^1.6.4
    * @libp2p/peer-id bumped from ^4.2.3 to ^4.2.4

## [4.2.3](https://github.com/libp2p/js-libp2p/compare/peer-id-factory-v4.2.2...peer-id-factory-v4.2.3) (2024-08-02)
...
## [4.2.0](https://github.com/libp2p/js-libp2p/compare/peer-id-factory-v4.1.4...peer-id-factory-v4.2.0) (2024-07-03)
