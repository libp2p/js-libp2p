...
export enum codes {
  ...
  ERR_TOO_MANY_OUTGOING_PROTOCOL_STREAMS = 'ERR_TOO_MANY_OUTGOING_PROTOCOL_STREAMS',
  ERR_TOO_MANY_INCOMING_PROTOCOL_STREAMS = 'ERR_TOO_MANY_INCOMING_PROTOCOL_STREAMS'
}
