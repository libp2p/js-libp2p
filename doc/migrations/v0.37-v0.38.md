...
When not specified, default values will be used as [defined in the registrar](https://github.com/libp2p/js-libp2p/blob/main/packages/libp2p/src/registrar.ts#L9-L10).
