...
Applications interested in peers that support certain protocols can register [topology callbacks](https://github.com/libp2p/js-libp2p/blob/main/packages/interface/src/topology.ts) to be notified when network peers that support those protocols connect or disconnect.
